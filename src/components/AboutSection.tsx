      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4 mb-4 sticky top-0 bg-black z-10 pt-4">
              {sections.map((section, index) => (
                <button
                  key={index}
                  className={`px-4 py-2 border-b-2 ${
                    activeIndex === index 
                      ? "border-yellow-400 text-2xl font-semibold text-yellow-400" 
                      : "border-gray-700 text-2xl font-semibold text-gray-400"
                  }`}
                  onClick={() => {
            ...
            <div className="space-y-6">
              {sections[activeIndex].faqs.map((faq, index) => (
                <div key={index} className="mb-6">
                  ...
                  >
                    <p className="text-xl md:text-2xl font-medium text-gray-200">{faq.question}</p>
                    <Plus size={20} className={`transition-transform border-2 rounded text-yellow-400 ${expandedIndex === index ? 'rotate-45' : ''}`} />
                  </div>
                  {expandedIndex === index && (
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center mt-8 gap-4">
              <button className="p-3 hover:bg-gray-800 transition rounded-full">
