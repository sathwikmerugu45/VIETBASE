  ...
  return (
    <section className="bg-black text-white py-16 md:py-10 lg:py-10 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Animated Subheading */}
        <motion.p
          className="text-lg md:text-xl text-gray-400 leading-relaxed mb-12"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <div className="team-content bg-gray-900 p-6">
              <h3 className="name text-xl font-bold text-yellow-400">K Goutham</h3>
              <h4 className="title text-gray-400 mt-2">IIT Madras, Consultant</h4>
              <div className="social mt-4">
                <a 
                  ...
                  className="inline-block p-2 bg-gray-800 rounded-full hover:bg-yellow-400 hover:text-black transition-colors"
                >
